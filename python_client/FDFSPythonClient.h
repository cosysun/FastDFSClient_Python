...
extern "C" {
    ...
    //      char *&pRemoteFileID        OUT 返回的文件名
    //      int &nNameSize              OUT 返回的文件名大小
    //          比如：group2/M00/00/00/CgEIzVRhnJWAZfVkAAAsFwWtoVg250.png
    //返回：0:成功 否则失败。
    //////////////////////////////////////////////////////////////////////////
    int upload_file(const char *sFileBuff, const int64_t nFileSize,
            const char *sFileExtName, char *&pRemoteFileID, int &nNameSize);
    ...
    //      const char *sFileBuff       IN 文件内容
    //      const int64_t nFileSize     IN 文件大小
    //      const char *sMasterFileID   IN 主文件名 存在服务端文件名
    //          比如：group1/M00/00/00/CgEIzVRhnJWAZfVkAAAsFwWtoVg250.png
    //      const char *sPrefixName     IN 从文件前缀名
    //          比如：_200*200
    //      const char *sFileExtName    IN 文件扩展名
    //      char *&pRemoteFileID        OUT 返回的文件名
    //          比如：group2/M00/00/00/CgEIzVRhnJWAZfVkAAAsFwWtoVg250_200*200.png
    //      int &nNameSize              OUT 返回的文件名大小
    //返回：0:成功 否则失败。
    //////////////////////////////////////////////////////////////////////////
    int upload_slave(const char *sFileBuff, const int64_t nFileSize,
    ...
    //返回：0:成功 否则失败。
    //////////////////////////////////////////////////////////////////////////
    int upload_appender(const char *sFileBuff, const int64_t nFileSize,
            const char *sFileExtName, char *&pRemoteFileID, int &nNameSize);
    ...
    //功能：下载文件
    //参数：
    //      const char* sReomteFileID   IN 存储名
    //          比如：group2/M00/00/00/CgEIzVRhnJWAZfVkAAAsFwWtoVg250.png
    ...
    //功能：获取文件信息
    //参数：
    //      const char *sReomteFileID   IN 文件名
    //          比如：group2/M00/00/00/CgEIzVRhnJWAZfVkAAAsFwWtoVg250.png
