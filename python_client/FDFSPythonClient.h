...
extern "C" {
    ...
    //功能：上传普通文件
    //参数：
    //      const char *file_buff       IN 文件内容
    //      int64_t file_size           IN 文件大小
    ...
    //返回：0:成功 否则失败。
    //////////////////////////////////////////////////////////////////////////
    int upload_slave(const char *file_content, int64_t file_size,
    ...
    //      BufferInfo* storages_infos  OUT 存储信息
    //返回：0:成功 否则失败。
    //备注：需要在主版本更新时检查信息是否需要再次更新，当前匹配版本V5.12
    //////////////////////////////////////////////////////////////////////////
